...
import javax.swing.JLabel;					//JLabel for Status Bar				
import javax.swing.JPanel;					//JPanel for UI
import javax.swing.Timer;					//Timer for GamePlay
import java.awt.Color;						//Color for UI
import java.awt.Graphics;					//Graphics for UI
import java.awt.event.ActionEvent;				//ActionEvent for Game Event
import java.awt.event.ActionListener;				//ActionListener for ActionEvent
import java.awt.event.KeyAdapter;				//KeyAdapter for key press
import java.awt.event.KeyEvent;					//KeyEvent for ActionPerform
